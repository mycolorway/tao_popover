...
(function() {
  ...
  TaoModule = (function() {
    ...
    TaoModule.include = function(obj) {
      var key, ref, val;
      if (!(obj && typeof obj === 'object')) {
    ...
    TaoModule.get = function(name, method) {
    ...
    TaoModule.set = function(name, method) {
      return Object.defineProperty(this.prototype, name, {
        set: method,
        configurable: true
      });
      ...
      return names.forEach((function(_this) {
        return function(name) {
          _this.get(name, function() {
            if (!_.isUndefined(this._proterties[name])) {
    ...
    TaoModule.prototype.off = function() {
      var args, ref;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return (ref = $(this)).off.apply(ref, args);
    };

    TaoModule.prototype.trigger = function() {
      var args, ref;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return (ref = $(this)).triggerHandler.apply(ref, args);
    };

    TaoModule.prototype.one = function() {
      var args, ref;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
...
(function() {
  ...
  TaoApplication = (function(superClass) {
    extend(TaoApplication, superClass);

    function TaoApplication() {
    ...
    TaoApplication.prototype._initUjs = function() {
      return $(document).on("ajax:before", 'a[data-remote]', function() {
        var $link;
        $link = $(this);
    ...
    TaoApplication.prototype._initTurbolinks = function() {
      ...
      })(this)).on('turbolinks:visit', (function(_this) {
        return function(e) {
          var ref;
      ...
      })(this)).on('turbolinks:request-end', (function(_this) {
        return function(e) {
          var ref;
...
(function() {
  ...
  TaoComponentBasedOn = function(superClassName) {
    ...
    ComponentClass = (function() {
      ...
      ComponentClass.prototype._reflow = function() {
        this.offsetHeight;
        return this;
      };
      ...
      ComponentClass.prototype.findComponent = function(selector, readyCallback) {
        var component;
        component = this.jq.find(selector).get(0);
        if (component.connected) {
          if (typeof readyCallback === "function") {
            readyCallback(component);
          }
        } else {
          this.one('connected', selector, function() {
            return typeof readyCallback === "function" ? readyCallback(component) : void 0;
          });
        }
        return component;
      };
      ...
      ComponentClass.prototype.trigger = function() {
        var args, ref;
        args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
        return (ref = this.jq).trigger.apply(ref, args);
      };

      ComponentClass.prototype.triggerHandler = function() {
        var args, ref;
        args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
...
(function() {
  ...
  TaoPage = (function(superClass) {
    extend(TaoPage, superClass);
